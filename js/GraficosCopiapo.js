...
var ctx2 = document.getElementById('GraficoCircularCopiapo').getContext('2d');
var data2 = {
    labels: ['Rojo', 'Azul', 'Verde', 'Amarillo', 'Naranja'],
    datasets: [{
      label: 'Ejemplo de Gráfico Circular',
...
var GraficoCircularCopiapo = new Chart(ctx2, {
  type: 'doughnut',
  data: data2,
  options: options2
});
